...
#    push @ios, new Say($i);
#}
# So the core is "new Say($i);" which means I'd need to know if this is a service or not, i.e. if it's in the Gannet namespace
...
( 
    my $io = new Say(1,2,3),
    my $io2 = new Say,
    my $io3 = new Say() # Say->new(1,2,3) is NOT supported
);
