...
//==============================================================================
//! This is the SC_MemArbiter_intchannel module, one for each master
    /*!
...
class SC_MemArbiter_intchannel :
    public sc_module  ,
...
*/
    // ---------------------------- CONSTRUCTORS ---------------------------------------
    SC_HAS_PROCESS( SC_MemArbiter_intchannel );
    SC_MemArbiter_intchannel<ADDR_T, DATA_T> (sc_module_name nm):
        sc_module(nm)
    {
        // debug message...
...
//*---------------------------------------------------------------------------------------------------------
//* Function Name       : SC_MemArbiter_intchannel :: write
...
template <typename ADDR_T, typename DATA_T>
void SC_MemArbiter_intchannel<ADDR_T, DATA_T> :: write (ADDR_T addr, DATA_T data)
{
...
//*---------------------------------------------------------------------------------------------------------
//* Function Name       : SC_MemArbiter_intchannel :: read
...
//*---------------------------------------------------------------------------------------------------------
template <typename ADDR_T, typename DATA_T>
DATA_T&  SC_MemArbiter_intchannel<ADDR_T, DATA_T> :: read(ADDR_T addr)
{
...
//*---------------------------------------------------------------------------------------------------------
//* Function Name       : SC_MemArbiter_intchannel :: is_free
//* Object              : check if address is free
//* Input Parameters    : address
//* Output Parameters   : bool (free or not)
//*---------------------------------------------------------------------------------------------------------
template <typename ADDR_T, typename DATA_T>
bool  SC_MemArbiter_intchannel<ADDR_T, DATA_T> :: is_free(ADDR_T addr)
{
    return(pwr_slave->is_free(addr));
}//is_free()

//*---------------------------------------------------------------------------------------------------------
//* Function Name       : SC_MemArbiter_intchannel :: size
//* Object              : check size of data stored at address for timing purposes
//* Input Parameters    : address
//* Output Parameters   : unsigned int
//*---------------------------------------------------------------------------------------------------------
template <typename ADDR_T, typename DATA_T>
unsigned  SC_MemArbiter_intchannel<ADDR_T, DATA_T> :: size(ADDR_T addr)
{
...
//==============================================================================
//! This is the SC_MemArbiter module
    /*
...
public:
    ...
    SC_MemArbiter_intchannel<ADDR_T, DATA_T>  master2arb1;
    SC_MemArbiter_intchannel<ADDR_T, DATA_T>  master2arb2;
    SC_MemArbiter_intchannel<ADDR_T, DATA_T>  master2arb3;
    SC_MemArbiter_intchannel<ADDR_T, DATA_T>  master2arb4;
    SC_MemArbiter_intchannel<ADDR_T, DATA_T>  master2arb5;
    ...
    virtual const char* kind() const
        { return "SC_MemArbiter"; }

public:
    // ---------------------------- CONSTRUCTOR --------------------------------
    SC_HAS_PROCESS( SC_MemArbiter );
    SC_MemArbiter( sc_module_name nm ) :
        sc_module( nm ) ,
