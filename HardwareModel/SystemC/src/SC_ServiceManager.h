...
//        arb_request_table       ("arb_request_table")       ,
        ...
        arb_arg_addresses       ("arb_arg_addresses")
    {
        ...
        //transmit_packets.tranceiver_tx_fifo .bind( tranceiver_tx_fifo );    // propagate upwards, port for writing tranceiver.tx_fifo
        ...
        parse_subtask.tx_fifo       .bind(arb_tx_fifo.xpw_master3 );    // to arbiter controlling tranceiver_tx_fifo
        ...
        // -- CORE_CONTROL ------------------
        core_control.tx_fifo                .bind( arb_tx_fifo.xpw_master1 );    // write access to tranceiver_tx_fifo through arbiter
        ...
        store_data.tx_fifo      .bind( arb_tx_fifo.xpw_master2 );    // write access to tranceiver_tx_fifo through arbiter
...
//        store_data.request_table.bind(arb_request_table.xpwr_master2);// access to request_table through arbiter
        ...
        // -- RECEIVE_PACKETS ---------------
        receive_packets.tranceiver_rx_fifo      .bind( tranceiver_rx_fifo ); // propagate the port for reading from tranceiver's rx_fifo
...
//        prepare_subtask.pending_subtasks_fifo   .bind(arb_pending_subtasks_fifo.xpw_master3);// write access to pending_subtasks_fifo through arbiter
        ...
        arb_tx_fifo.pw_slave                .bind( tranceiver_tx_fifo );     //propagate slave port of tx_fifo arbiter for connection to tranceiver_tx_fifo
