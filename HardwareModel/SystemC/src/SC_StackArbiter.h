...
//==============================================================================
//! This is the SC_StackArbiter_int_channel module, one for each master
    /*!
    ...
    */
class SC_StackArbiter_int_channel :
    public sc_module  ,
    public SC_Stack_if
{
public:
    ...
    // ---------------------------- CONSTRUCTORS ---------------------------------------
    SC_StackArbiter_int_channel (sc_module_name nm):
        sc_module(nm) {}
};//SC_StackArbiter_int_channel
...
//==============================================================================
//! This is the SC_StackArbiter module
    /*
...
public:
    ...
    // ---------------------------- LOCALS -------------------------------------
    // One instance each of "SC_StackArbiter_int_delayed_put_channel" for each master connected to arbiter
    SC_StackArbiter_int_channel master2arb1;
    SC_StackArbiter_int_channel master2arb2;
    SC_StackArbiter_int_channel master2arb3;
    SC_StackArbiter_int_channel master2arb4;
    ...
    virtual const char* kind() const
        { return "SC_StackArbiter"; }


public:
    // ---------------------------- CONSTRUCTOR --------------------------------
    SC_HAS_PROCESS( SC_StackArbiter );
    SC_StackArbiter( sc_module_name nm ) :
        sc_module( nm ) ,
