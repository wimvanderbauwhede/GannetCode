...
//==============================================================================
//! This is the SC_Fifo_Arbiter_int_channel module, one for each master
    /*!
...
class SC_Fifo_Arbiter_int_channel :
    public sc_module  ,
...
public:
    ...
    // ---------------------------- CONSTRUCTORS ---------------------------------------
    SC_Fifo_Arbiter_int_channel<DATA_T> (sc_module_name nm):
        sc_module(nm) {}
};//SC_Fifo_Arbiter_int_channel


//------------------------------------------------------------------------------
//  SC_Fifo_Arbiter_int_channel::shift()
//------------------------------------------------------------------------------
template <typename DATA_T>
DATA_T SC_Fifo_Arbiter_int_channel<DATA_T> :: shift ()
{
...
/*
//------------------------------------------------------------------------------
//  SC_Fifo_Arbiter_int_channel::unshift()
//------------------------------------------------------------------------------
template <typename DATA_T>
void SC_Fifo_Arbiter_int_channel<DATA_T> :: unshift (DATA_T& val_)
{
    p_mutex->lock();
...
//------------------------------------------------------------------------------
//  SC_Fifo_Arbiter_int_channel::push()
//------------------------------------------------------------------------------
template <typename DATA_T>
void SC_Fifo_Arbiter_int_channel<DATA_T> :: push (DATA_T& val_)
{
//    OSTREAM << std::setw(12) << setfill(' ') << sc_time_stamp() << ": "
...
/*
//------------------------------------------------------------------------------
//  SC_Fifo_Arbiter_int_channel::pop()
//------------------------------------------------------------------------------
template <typename DATA_T>
DATA_T SC_Fifo_Arbiter_int_channel<DATA_T> :: pop ()
{
    p_mutex->lock();
...
//==============================================================================
//! This is the SC_Fifo_Arbiter module
    /*
...
public:
    ...
    SC_Fifo_Arbiter_int_channel<DATA_T>  master2arb1;
    SC_Fifo_Arbiter_int_channel<DATA_T>  master2arb2;
    SC_Fifo_Arbiter_int_channel<DATA_T>  master2arb3;
    SC_Fifo_Arbiter_int_channel<DATA_T>  master2arb4;
    SC_Fifo_Arbiter_int_channel<DATA_T>  master2arb5;
    ...
    virtual const char* kind() const
        { return "SC_Fifo_Arbiter"; }


public:
    // ---------------------------- CONSTRUCTOR --------------------------------
    SC_HAS_PROCESS( SC_Fifo_Arbiter );
    SC_Fifo_Arbiter( sc_module_name nm ) :
        sc_module( nm ) ,
