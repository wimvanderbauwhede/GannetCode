...
********************************************************************************
                 |
  File Name      | SC_Register_Arbiter.h
-----------------|--------------------------------------------------------------
...
//==============================================================================
//! This is the SC_Register_Arbiter_intchannel module, one for each master
    /*!
...
class SC_Register_Arbiter_intchannel :
    public sc_module  ,
...
//        << "SC_Register_Arbiter_intchannel "<<name()<<" value_changed_event() called\n";
    ...
    // ---------------------------- CONSTRUCTOR  ---------------------------------------
    SC_HAS_PROCESS( SC_Register_Arbiter_intchannel );
    SC_Register_Arbiter_intchannel<DATA_T> (sc_module_name nm):
        sc_module(nm)
    {
        // debug message...
        //const_debug_msg(name(),kind());
    }
};//SC_Register_Arbiter_intchannel

//*---------------------------------------------------------------------------------------------------------
//* write   (const DATA_T& val_ )
//*---------------------------------------------------------------------------------------------------------
template <typename DATA_T>
void SC_Register_Arbiter_intchannel<DATA_T> :: write   (const DATA_T& val_ )
{
...
//*---------------------------------------------------------------------------------------------------------
template <typename DATA_T>
DATA_T& SC_Register_Arbiter_intchannel<DATA_T> :: read  ()
{
...
template <typename DATA_T>
void SC_Register_Arbiter_intchannel<DATA_T> :: operator =  (const DATA_T& rhs_)
{
    p_mutex->lock();
...
template <typename DATA_T>
bool SC_Register_Arbiter_intchannel<DATA_T> :: operator  == (const DATA_T& rhs_)
{
...
//*---------------------------------------------------------------------------------------------------------
template <typename DATA_T>
SC_Register_Arbiter_intchannel<DATA_T> :: operator DATA_T& ()
{
    return ( pwr_slave->read());
}
...
//==============================================================================
//! This is the SC_Register_Arbiter module
    /*
...
public:
    ...
    // ---------------------------- LOCALS -------------------------------------
    // One instance each of "SC_Register_Arbiter_intchannel" for each master connected to arbiter
    SC_Register_Arbiter_intchannel<DATA_T>  master2arb1;
    SC_Register_Arbiter_intchannel<DATA_T>  master2arb2;
    SC_Register_Arbiter_intchannel<DATA_T>  master2arb3;
    SC_Register_Arbiter_intchannel<DATA_T>  master2arb4;
    ...
    virtual const char* kind() const
        { return "SC_Register_Arbiter"; }

public:
    // ---------------------------- CONSTRUCTOR --------------------------------
    SC_HAS_PROCESS( SC_Register_Arbiter );
    SC_Register_Arbiter( sc_module_name nm ) :
        sc_module( nm ) ,
        ...
        master2arb4("master2arb4")
    {
        ...
        //master2arb1 = new SC_Register_Arbiter_intchannel<DATA_T>("master2arb1");
        //master2arb2 = new SC_Register_Arbiter_intchannel<DATA_T>("master2arb2");
        //master2arb3 = new SC_Register_Arbiter_intchannel<DATA_T>("master2arb3");
    	//master2arb4 = new SC_Register_Arbiter_intchannel<DATA_T>("master2arb4");
    	// Bindings
        // ========
    ...
    const sc_event& value_changed_event () const {
    	OSTREAM << std::setw(12) << setfill(' ') << sc_time_stamp() << ": "
        << "SC_Register_Arbiter "<<name()<<" value_changed_event() called, value is now "<< master2arb1->read()<< "\n";
