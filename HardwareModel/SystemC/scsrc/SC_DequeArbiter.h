...
//==============================================================================
//! This is the SC_DequeArbiter_int_channel module, one for each master
    /*!
...
class SC_DequeArbiter_int_channel :
    public sc_module  ,
...
public:
    ...
    // ---------------------------- CONSTRUCTORS ---------------------------------------
    SC_DequeArbiter_int_channel<DATA_T> (sc_module_name nm):
        sc_module(nm) {}
};//SC_DequeArbiter_int_channel
...
//==============================================================================
//! This is the SC_DequeArbiter module
    /*
...
public:
    ...
    SC_DequeArbiter_int_channel<DATA_T>  master2arb1;
    SC_DequeArbiter_int_channel<DATA_T>  master2arb2;
    SC_DequeArbiter_int_channel<DATA_T>  master2arb3;
    SC_DequeArbiter_int_channel<DATA_T>  master2arb4;
    ...
    virtual const char* kind() const
        { return "SC_DequeArbiter"; }


public:
    // ---------------------------- CONSTRUCTOR --------------------------------
    SC_HAS_PROCESS( SC_DequeArbiter );
    SC_DequeArbiter( sc_module_name nm ) :
        sc_module( nm ) ,
