...
********************************************************************************
                 |
  File Name      | SC_Subtask_List_Arbiter.h
-----------------|--------------------------------------------------------------
...
//==============================================================================
//! This is the SC_Subtask_List_Arbiter_intchannel module, one for each master trying to access Subtask_List
    /*!
...
class SC_Subtask_List_Arbiter_intchannel :
    public sc_module  ,
...
public:
    ...
    // ---------------------------- CONSTRUCTORS ---------------------------------------
    SC_HAS_PROCESS( SC_Subtask_List_Arbiter_intchannel );
    SC_Subtask_List_Arbiter_intchannel (sc_module_name nm):
        sc_module(nm)
    {
        // debug message...
...
//==============================================================================
//! This is the SC_Subtask_List_Arbiter module
    /*
...
public:
    ...
    // ---------------------------- LOCALS -------------------------------------
    // One instance each of "SC_Subtask_List_Arbiter_intchannel" for each master connected to arbiter
    SC_Subtask_List_Arbiter_intchannel master2arb1;
    SC_Subtask_List_Arbiter_intchannel master2arb2;
    SC_Subtask_List_Arbiter_intchannel master2arb3;
    SC_Subtask_List_Arbiter_intchannel master2arb4;
    SC_Subtask_List_Arbiter_intchannel master2arb5;
    SC_Subtask_List_Arbiter_intchannel master2arb6;
    SC_Subtask_List_Arbiter_intchannel master2arb7;
    SC_Subtask_List_Arbiter_intchannel master2arb8;
    ...
    virtual const char* kind() const
        { return "SC_Subtask_List_Arbiter"; }

public:
    // ---------------------------- CONSTRUCTOR --------------------------------
    SC_HAS_PROCESS( SC_Subtask_List_Arbiter );
    SC_Subtask_List_Arbiter( sc_module_name nm ) :
        sc_module( nm ) ,
